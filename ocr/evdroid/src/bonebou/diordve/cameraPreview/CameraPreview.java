...
//this class is instantiated my the main activity class (Evdroid)
public class CameraPreview implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public void onPreviewFrame ( byte[] arg0, Camera arg1 ) {
        ...
        if ( !self.is_processing ) {
            ...
            new CameraPreview_objectDetect().execute (
    ...
    //=======================
    class CameraPreview_objectDetect extends AsyncTask<Integer, Integer, String> {
